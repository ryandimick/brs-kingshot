...
import { widgetExpeditionStats, widgetSkillValue } from "../../data/hero-tables";
import { offProduct, defProduct, marginal, baseStatsFor } from "../combat";
import { weightsFor } from "../scoring";
